...
CREATE TABLE IF NOT EXISTS `jemaro`.`vehicleBrand` (
  ...
  `vehicleBrandImg` LONGBLOB NULL,
  `vehicleBrandImgType` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `jemaro`.`productBrand` (
  ...
  `productBrandImg` LONGBLOB NULL,
  `productBrandImgType` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `jemaro`.`productImage` (
  `id` INT NULL AUTO_INCREMENT,
  `productImg` LONGBLOB NULL,
  `productImgType` VARCHAR(45) NULL,
  `productCode` VARCHAR(45) NULL,
  `productBrand` VARCHAR(45) NULL,
  `productClass` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
