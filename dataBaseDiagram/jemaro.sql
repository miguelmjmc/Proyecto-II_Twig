...
CREATE TABLE IF NOT EXISTS `jemaro`.`person` (
  ...
  UNIQUE INDEX `telf_UNIQUE` (`telf` ASC),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_person_configuration1_idx` (`configuration_id` ASC),
  CONSTRAINT `fk_person_configuration1`
    FOREIGN KEY (`configuration_id`)
    REFERENCES `jemaro`.`configuration` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `jemaro`.`about` (
  ...
  `configuration_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_about_configuration1_idx` (`configuration_id` ASC),
  CONSTRAINT `fk_about_configuration1`
    FOREIGN KEY (`configuration_id`)
    REFERENCES `jemaro`.`configuration` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
