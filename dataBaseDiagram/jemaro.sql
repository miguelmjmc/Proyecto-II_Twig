...
CREATE TABLE IF NOT EXISTS `jemaro`.`vehicleBrand` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `marca_vehiculo_UNIQUE` (`name` ASC),
...
CREATE TABLE IF NOT EXISTS `jemaro`.`productBrand` (
  ...
  `name` VARCHAR(45) NOT NULL,
  `img` LONGBLOB NOT NULL,
  UNIQUE INDEX `idmarca_producto_UNIQUE` (`name` ASC),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `jemaro`.`productClass` (
  ...
  `name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `tipo_producto_UNIQUE` (`name` ASC),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `jemaro`.`productCategory` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  UNIQUE INDEX `iddepartamento_producto_UNIQUE` (`name` ASC),
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC))
ENGINE = InnoDB;
